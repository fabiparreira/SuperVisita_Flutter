...
class FormularioVisita extends StatefulWidget {
  FormularioVisita({Key key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return FormularioVisitaState();
  }
}

class FormularioVisitaState extends State<FormularioVisita> {
...
/*  final TextEditingController _ctrlVisita = TextEditingController();
  ...
  Widget build(BuildContext context) {
    return Column(
        ...
        RaisedButton(
          onPressed: (){
            Navigator.pop(context, FormularioVisita());
          },
        )
        ]
    );
